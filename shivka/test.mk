...
PROJECT_FILE=@@FILE_ADRESS@@/my.pto
PROJECT_FILE_SHELL=@@FILE_ADRESS@@/my.pto
LDR_BLENDED=my.jpg
...
# first input image
INPUT_IMAGE_1=@@FILE_ADRESS@@/@@%%1%%@@
INPUT_IMAGE_1_SHELL=@@FILE_ADRESS@@/@@%%1%%@@

# all input images
INPUT_IMAGES=@@FILE_ADRESS@@/@@%%1%%@@\
@@FILE_ADRESS@@/@@%%2%%@@\
@@FILE_ADRESS@@/@@%%3%%@@\
@@FILE_ADRESS@@/@@%%4%%@@\
@@FILE_ADRESS@@/@@%%5%%@@\
...
@@FILE_ADRESS@@/@@%%11%%@@\
@@FILE_ADRESS@@/@@%%12%%@@
INPUT_IMAGES_SHELL=@@FILE_ADRESS@@/@@%%1%%@@\
@@FILE_ADRESS@@/@@%%2%%@@\
@@FILE_ADRESS@@/@@%%3%%@@\
@@FILE_ADRESS@@/@@%%4%%@@\
@@FILE_ADRESS@@/@@%%5%%@@\
...
info : 
	...
	@echo 'Project file: @@FILE_ADRESS@@/my.pto'
...
my_exposure_layers_0001.tif : @@FILE_ADRESS@@/@@%%2%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0002.tif : @@FILE_ADRESS@@/@@%%3%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0010.tif : @@FILE_ADRESS@@/@@%%11%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0011.tif : @@FILE_ADRESS@@/@@%%12%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0003.tif : @@FILE_ADRESS@@/@@%%4%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0005.tif : @@FILE_ADRESS@@/@@%%6%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0007.tif : @@FILE_ADRESS@@/@@%%8%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0009.tif : @@FILE_ADRESS@@/@@%%10%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0004.tif : @@FILE_ADRESS@@/@@%%5%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0006.tif : @@FILE_ADRESS@@/@@%%7%%@@ $(PROJECT_FILE)
...
my_exposure_layers_0008.tif : @@FILE_ADRESS@@/@@%%9%%@@ $(PROJECT_FILE)
